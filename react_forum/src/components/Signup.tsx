        ...
        <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <span className={validPassword || !email ? "hide" : "invalid"}></span>
            </label>
            <input
              type="password"
              name="password"
            ...
            >
              Password again
              <span className={validConfirm && confirm ? "valid" : "hide"}></span>
              <span className={validConfirm || !confirm ? "hide" : "invalid"}></span>
            </label>
            <input
              type="password"
              name="confirm"
